...
public class Part2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Hybrid Sort execution time: " + (end-start));
        //starting measuring
        start = System.currentTimeMillis();
        quickSort(originalArray,0,originalArray.length-1);
        end = System.currentTimeMillis();
        //printing measurement
        System.out.println("Quick Sort execution time: " + (end-start));
    ...
    static void hybridSort(int[] arr) {
        // Implement here...start with quick sort
    ...
    {
        if (l < r) {
        	//we use insertion sort if element number is less than 15
            if(r-l <= 14){
            ...
            // Sort first and second halves using quick sort
            quickSort(arr, l, m);
            quickSort(arr, m + 1, r);
    ...
    */
    ...
    static void quickSort(int[] arr, int low, int high)
    {
        if (low < high)
        {
            //if there are less than 15 elements, we go to insertion sort
            if(high-low <= 14){
            ...
            // Separately sort elements before using merge sort
